...
try{
  ...
  logger.error('LevelUp is NOT installed, please "npm install levelup" to use this module');
  throw e;
}
...
try{
  ...
  logger.error(provider+' is NOT installed, please "npm install '+provider+'" to use this module');
  throw e;
}
...
try{
  ...
  logger.error('bson-objectid not found, falling back to default uuid');
  var uuid = function(){
    id = (new Date()).getTime();
